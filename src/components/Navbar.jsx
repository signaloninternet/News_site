...
function Navbar() {
  ...
  return (
    <div className="p-8 mx-8 flex flex-row justify-between items-center">
      ...
      {/* Desktop Menu */}
      <div className="hidden sm:flex menu flex flex-row items-center justify-center gap-12">
      ...
      <div className="sm:hidden">
        <RiMenuLine onClick={toggleMenu} className="text-3xl text-gray-800 hover:text-purple-600 cursor-pointer transition-colors duration-300" />
      </div>
